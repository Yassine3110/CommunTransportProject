        ...
        public ActionResult Demandes()
        {
            ...
            if (Session["IDSociete"] != null)
            {
                ...
                var demande = demandes.Where(n => n.IDSociete == id)                               
                    .GroupBy(n => new { DateDebut = n.DateDebut, DateFin = n.DateDebut, HeureDep = n.HeureDep, HeureDarr = n.HeureDarr, IDVilleDep = n.Ville.Libelle, IDVilleDarr = n.Ville1.Libelle })
                    .Select(g => new GérerDemande {  DateDebut = g.Key.DateDebut, DateFin = g.Key.DateDebut, HeureDep = g.Key.HeureDep, HeureDarr = g.Key.HeureDarr, IDVilleDep = g.Key.IDVilleDep, IDVilleDarr = g.Key.IDVilleDarr,nbr=g.Count() });
